...
const Login = () => {
  ...
  return (
    <div>
      <div className="min-h-screen bg-login w-full h-screen bg-cover bg-center flex justify-center items-center">
        <Helmet>
          <title>Login - Edifica</title>
        </Helmet>
        <div className="h-full w-full bg-base-100/50 backdrop-blur flex items-center justify-center">
          <div>
            <LoginForm />
          </div>
        </div>
